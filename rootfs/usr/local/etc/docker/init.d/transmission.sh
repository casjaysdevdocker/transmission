...
RUN_DIR="/run/init.d"
# set log directory
LOG_DIR="/data/logs/transmission"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SERVICE_USER="root"
# command to execute
EXEC_CMD_BIN="transmission-daemon"
# command arguments
EXEC_CMD_ARGS="-f --config-dir $CONF_DIR/"
...
# usernames
# normal user name
user_name="${TRANSMISSION_USER_NAME:-}"
# root user name
root_user_name="${TRANSMISSION_ROOT_USER_NAME:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# passwords [password/random]
# normal user password
user_pass="${TRANSMISSION_USER_PASS_WORD:-}"
# root user password
root_user_pass="${TRANSMISSION_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
